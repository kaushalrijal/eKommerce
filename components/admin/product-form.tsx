  ...
  return (
    <Form {...form}>
      <form method="POST" onSubmit={form.handleSubmit(submitForm)} className="space-y-8">
        ...
        <div className="flex flex-col upload-field gap-5 md:flex-row">
          {/* Images */}
          <FormField
            control={form.control}
            name="images"
                    ...
                    <CardContent className="space-y-2 mt-2 min-h-48">
                      <div className="flex-start space-x-2">
                        { images.map((image: string)=>(
                          <Image src={image} key={image} alt="product image" className="w-20 h-20 object-cover object-center rounded-sm" width={100} height={100}/>
                        ))}
        ...
        <div>{/* Submit */}
            <Button type="submit" size={"lg"} disabled={form.formState.isSubmitting} className="button col-span-2">
